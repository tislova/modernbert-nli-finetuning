...
| # | Premise                              | Hypothesis                       | Expected   | Predicted     | Result        |
| - | ------------------------------------ | -------------------------------- | ---------- | ------------- | ------------- |
| 1 | A woman is slicing a pie.            | A woman is baking a pie.         | neutral    | entailment    | H1 confirmed  |
| 2 | He is angry.                         | He is not calm.                  | entailment | contradiction | H2 confirmed  |
| 3 | They are throwing a ball.            | They are playing.                | entailment | entailment    | H3 (correct)  |
| 4 | The weather is sunny right now.      | She will not take an umbrella.   | neutral    | contradiction | H4 confirmed  |
